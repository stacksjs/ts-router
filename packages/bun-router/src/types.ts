...
// Module augmentation to add streaming and model binding methods to Router class
declare module './router/core' {
  interface Router {
    // Core HTTP Methods
    get: (path: string, handler: RouteHandler, middlewareOrGroup?: string | MiddlewareHandler | (string | MiddlewareHandler)[], routeName?: string, middleware?: (string | MiddlewareHandler)[]) => Promise<Router>
    post: (path: string, handler: RouteHandler, middlewareOrGroup?: string | MiddlewareHandler | (string | MiddlewareHandler)[], routeName?: string, middleware?: (string | MiddlewareHandler)[]) => Promise<Router>
    put: (path: string, handler: RouteHandler, middlewareOrGroup?: string | MiddlewareHandler | (string | MiddlewareHandler)[], routeName?: string, middleware?: (string | MiddlewareHandler)[]) => Promise<Router>
    patch: (path: string, handler: RouteHandler, middlewareOrGroup?: string | MiddlewareHandler | (string | MiddlewareHandler)[], routeName?: string, middleware?: (string | MiddlewareHandler)[]) => Promise<Router>
    delete: (path: string, handler: RouteHandler, middlewareOrGroup?: string | MiddlewareHandler | (string | MiddlewareHandler)[], routeName?: string, middleware?: (string | MiddlewareHandler)[]) => Promise<Router>
    head: (path: string, handler: RouteHandler, middlewareOrGroup?: string | MiddlewareHandler | (string | MiddlewareHandler)[], routeName?: string, middleware?: (string | MiddlewareHandler)[]) => Promise<Router>
    options: (path: string, handler: RouteHandler, middlewareOrGroup?: string | MiddlewareHandler | (string | MiddlewareHandler)[], routeName?: string, middleware?: (string | MiddlewareHandler)[]) => Promise<Router>
    
    // Server Methods
    serve: (options?: { port?: number; hostname?: string }) => Promise<Server>
    handleRequest: (request: Request) => Promise<Response>
    
    // Middleware
    use: (middleware: MiddlewareHandler | string) => Router
    ...
    match: (methods: string[], path: string, handler: RouteHandler, middleware?: string | MiddlewareHandler | (string | MiddlewareHandler)[]) => Promise<Router>
    any: (path: string, handler: RouteHandler, middleware?: string | MiddlewareHandler | (string | MiddlewareHandler)[]) => Promise<Router>
    
    // Route Constraints
    where: (constraints: Record<string, string>) => Router
    ...
    permanentRedirect: (to: string) => Response
    redirectRoute: (from: string, to: string, status?: number) => Promise<Router>
    
    // Error Handling
    onError: (handler: (error: any) => Response) => Promise<Router>
    ...
    // Domain Routing
    domain: (domain: string, callback: () => void) => Promise<Router>
    
    // Additional Middleware
    middleware: (...middlewares: (string | MiddlewareHandler)[]) => Router
     ...
     */
    modelRegistry: import('./model-binding').ModelBindingRegistry

    /**
     * Bind a model resolver to the router
     */
    bindModel: <T extends import('./model-binding').Model>(
      name: string, 
      resolver: import('./model-binding').ModelResolver<T> | import('./model-binding').ModelClass<T>
    ) => Router
     ...
     */
    onModelNotFound: (
      handler: (error: import('./model-binding').ModelNotFoundError, req: EnhancedRequest) => Response
    ) => Router
    ...
    getWithBinding: (
      path: string,
      handler: any,
      options?: import('./model-binding').RouteBindingOptions & { middleware?: (string | MiddlewareHandler)[] }
    ) => Promise<Router>
    ...
    resourceWithBinding: (
      ...
      options?: {
        ...
        bindings?: Record<string, import('./model-binding').ModelBindingConfig>
        middleware?: (string | MiddlewareHandler)[]
      }
    ) => Promise<Router>
     ...
     */
    modelNotFoundHandler: ((error: import('./model-binding').ModelNotFoundError, req: EnhancedRequest) => Response) | null
  }
}
